/* Purchase & Sales reference numbers — unique per company, reset each financial year (Apr–Mar) */
USE PawanPutra;
GO
...
PRINT 'Company-scoped purchase/sales reference numbers applied (resets each financial year Apr–Mar).';
GO
