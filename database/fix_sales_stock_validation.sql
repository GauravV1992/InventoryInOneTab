/* Run on existing PawanPutra DB — aggregated stock check before sales save
   (same material + warehouse on multiple lines is totalled first) */
USE PawanPutra;
GO
...
PRINT 'Sales stock validation updated (aggregated by material + warehouse).';
GO
